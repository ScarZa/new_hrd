          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o text-green"></i> เพิ่มข้อมูลบุคลากร</a></li>
                <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o text-green"></i> ข้อมูลบุคลากร</a></li>
                <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o text-green"></i> ประวัตฺการศึกษา</a></li>
                <li><a href="pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o text-green"></i> ข้อมูลบุคลากรย้าย/ลาออก</a></li>
                <li>
                  <a href="#"><i class="fa fa-circle-o text-blue"></i> รายงาน <i class="fa fa-angle-left pull-right"></i></a>
                  <ul class="treeview-menu">
                    <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> สถิติบุคลากร</a></li>
                    <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> สถิติประเภทพนักงาน</a></li>
                    <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> สถิติตำแหน่งพนักงาน</a></li>
                    </ul>
            </li>
              </ul>
            </li>
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o text-red"></i> บันทึกทะเบียนรับใบลา</a></li>
                <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o text-red"></i> บันทึกการลาบุคลากร</a></li>
